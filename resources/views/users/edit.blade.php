    ...
    <div class="row">
        ...
        <div class="col-md-4">
            {!! Form::open(array('method' => 'DELETE',
                ...
                'data-bootbox-message' => 'Are you sure you want to completely delete your account?',
                'class' => 'pull-right')) !!}

            {!! Form::button('Delete My Account', ['type' => 'submit', 'class' => 'btn btn-danger bootbox-confirm']) !!}
